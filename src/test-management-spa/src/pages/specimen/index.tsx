...
import { useSpecimenInformationForm } from './useSpecimen';
import { useBookingList } from '../../common/data/booking';

const Specimen: React.FunctionComponent = () => {
						...
						<div className="md:grid md:grid-cols-3 md-gap-6">
							<div className="px-4 md:col-span-1 sm:px-1">
								...
								<p className="mt-1 text-sm text-gray-600">
									Pick the booking for which we will fill in specimen Information
								</p>
							</div>
										...
										<div>
											...
											<div className="relative mt-1 rounded-md shadow-sm">
												...
												<div className="absolute inset-y-0 right-0 flex items-center">
													<label htmlFor="specimenTypeId" className="sr-only">
														Booking Status
													</label>
													<select
														id="specimenTypeId"
														{...register('specimenTypeId')}
